...
driver.get("https://auth.wikimedia.org/frwiki/wiki/Sp%C3%A9cial:Cr%C3%A9er_un_compte?useformat=desktop&usesul3=1&returnto=Wikip%C3%A9dia%3AAccueil+principal&centralauthLoginToken=ec8fed23b02068cab6e07643353e6ccd")
...
print("Tous les champs ont été correctement remplis.")
